...
class AppendTestResultsService(
    ...
    suspend fun appendGroupedTestRun(existingPublicId: PublicId, groupedResults: GroupedResults): Pair<Long, TestRunSummary> =
        withContext(Dispatchers.IO) {
            ...
            val testRunId = testRunRepository.appendTestSuites(existingPublicId, highestExistingTestSuiteIdx + 1, groupedResults.groupedTestSuites)
