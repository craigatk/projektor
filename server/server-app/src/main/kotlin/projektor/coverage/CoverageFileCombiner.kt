...
fun combineCoverageFiles(
    existingCoverageFiles: List<CoverageFile>,
    incomingCoverageFiles: List<CoverageFile>,
): List<CoverageFile> {
    ...
    val updatedCoverageFiles =
        existingCoverageFiles.map { existingCoverageFile ->
            ...
            if (matchedIncomingCoverageFile != null) {
                ...
                val missedLines: Array<Int> =
                    existingCoverageFile.missedLines.intersect(
                        matchedIncomingCoverageFile.missedLines.toList(),
                    ).toTypedArray()
                ...
                existingCoverageFile.copy(
                    ...
                    stats =
                        existingCoverageFile.stats.copy(
