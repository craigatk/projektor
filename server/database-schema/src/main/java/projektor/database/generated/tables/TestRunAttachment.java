...
public class TestRunAttachment extends TableImpl<TestRunAttachmentRecord> {
    ...
    private static final long serialVersionUID = 450183362;
     ...
     */
    public final TableField<TestRunAttachmentRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('test_run_attachment_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.test_run_attachment.file_name</code>.
     */
    public final TableField<TestRunAttachmentRecord, String> FILE_NAME = createField(DSL.name("file_name"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.test_run_attachment.object_name</code>.
     */
    public final TableField<TestRunAttachmentRecord, String> OBJECT_NAME = createField(DSL.name("object_name"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.test_run_attachment.file_size</code>.
     */
    public final TableField<TestRunAttachmentRecord, Long> FILE_SIZE = createField(DSL.name("file_size"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>public.test_run_attachment.test_run_public_id</code>.
     */
    public final TableField<TestRunAttachmentRecord, String> TEST_RUN_PUBLIC_ID = createField(DSL.name("test_run_public_id"), org.jooq.impl.SQLDataType.VARCHAR(12), this, "");
