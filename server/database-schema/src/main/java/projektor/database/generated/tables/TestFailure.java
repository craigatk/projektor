...
public class TestFailure extends TableImpl<TestFailureRecord> {
     ...
     */
    public final TableField<TestFailureRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('test_failure_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.test_failure.test_case_id</code>.
     */
    public final TableField<TestFailureRecord, Long> TEST_CASE_ID = createField(DSL.name("test_case_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('test_failure_test_case_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.test_failure.failure_message</code>.
     */
    public final TableField<TestFailureRecord, String> FAILURE_MESSAGE = createField(DSL.name("failure_message"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.test_failure.failure_type</code>.
     */
    public final TableField<TestFailureRecord, String> FAILURE_TYPE = createField(DSL.name("failure_type"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.test_failure.failure_text</code>.
     */
    public final TableField<TestFailureRecord, String> FAILURE_TEXT = createField(DSL.name("failure_text"), org.jooq.impl.SQLDataType.CLOB, this, "");
