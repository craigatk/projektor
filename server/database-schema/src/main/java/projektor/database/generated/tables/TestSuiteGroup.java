...
public class TestSuiteGroup extends TableImpl<TestSuiteGroupRecord> {
    ...
    private static final long serialVersionUID = -2043247141;
     ...
     */
    public final TableField<TestSuiteGroupRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('test_suite_group_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.test_suite_group.test_run_id</code>.
     */
    public final TableField<TestSuiteGroupRecord, Long> TEST_RUN_ID = createField(DSL.name("test_run_id"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>public.test_suite_group.group_name</code>.
     */
    public final TableField<TestSuiteGroupRecord, String> GROUP_NAME = createField(DSL.name("group_name"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.test_suite_group.group_label</code>.
     */
    public final TableField<TestSuiteGroupRecord, String> GROUP_LABEL = createField(DSL.name("group_label"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.test_suite_group.directory</code>.
     */
    public final TableField<TestSuiteGroupRecord, String> DIRECTORY = createField(DSL.name("directory"), org.jooq.impl.SQLDataType.CLOB, this, "");
