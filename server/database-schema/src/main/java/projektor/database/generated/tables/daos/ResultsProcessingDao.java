...
public class ResultsProcessingDao extends DAOImpl<ResultsProcessingRecord, projektor.database.generated.tables.pojos.ResultsProcessing, String> {
     ...
     */
    public List<projektor.database.generated.tables.pojos.ResultsProcessing> fetchRangeOfCreatedTimestamp(Timestamp lowerInclusive, Timestamp upperInclusive) {
