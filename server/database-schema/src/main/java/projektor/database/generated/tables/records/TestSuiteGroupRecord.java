...
public class TestSuiteGroupRecord extends UpdatableRecordImpl<TestSuiteGroupRecord> implements Record4<Long, Long, String, String> {

    private static final long serialVersionUID = 359600542;
     ...
     */
    @Override
    public TestSuiteGroupRecord values(Long value1, Long value2, String value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TestSuiteGroupRecord(Long id, Long testRunId, String groupName, String groupLabel) {
        super(TestSuiteGroup.TEST_SUITE_GROUP);
