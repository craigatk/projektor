...
public class TestRunSystemAttributes extends TableImpl<TestRunSystemAttributesRecord> {
    ...
    private static final long serialVersionUID = 922692191;
     ...
     */
    public final TableField<TestRunSystemAttributesRecord, String> TEST_RUN_PUBLIC_ID = createField(DSL.name("test_run_public_id"), org.jooq.impl.SQLDataType.VARCHAR(12).nullable(false), this, "");

    /**
     * The column <code>public.test_run_system_attributes.pinned</code>.
     */
    public final TableField<TestRunSystemAttributesRecord, Boolean> PINNED = createField(DSL.name("pinned"), org.jooq.impl.SQLDataType.BOOLEAN.nullable(false), this, "");
