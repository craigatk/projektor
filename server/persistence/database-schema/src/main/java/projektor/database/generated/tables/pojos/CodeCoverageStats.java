...
public class CodeCoverageStats implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.scope == null) {
            ...
            return false;
        if (this.statementCovered == null) {
            if (other.statementCovered != null)
                return false;
        }
        else if (!this.statementCovered.equals(other.statementCovered))
            return false;
        if (this.statementMissed == null) {
            if (other.statementMissed != null)
                return false;
        }
        else if (!this.statementMissed.equals(other.statementMissed))
            return false;
        if (this.lineCovered == null) {
            if (other.lineCovered != null)
                return false;
        }
        else if (!this.lineCovered.equals(other.lineCovered))
            return false;
        if (this.lineMissed == null) {
            if (other.lineMissed != null)
                return false;
        }
        else if (!this.lineMissed.equals(other.lineMissed))
            return false;
        if (this.branchCovered == null) {
            if (other.branchCovered != null)
                return false;
        }
        else if (!this.branchCovered.equals(other.branchCovered))
            return false;
        if (this.branchMissed == null) {
            if (other.branchMissed != null)
                return false;
        }
        else if (!this.branchMissed.equals(other.branchMissed))
            return false;
        return true;
    }
