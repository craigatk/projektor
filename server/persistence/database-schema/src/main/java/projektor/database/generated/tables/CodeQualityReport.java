...
public class CodeQualityReport extends TableImpl<CodeQualityReportRecord> {
    ...
    private CodeQualityReport(Name alias, Table<CodeQualityReportRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    public <O extends Record> CodeQualityReport(Table<O> path, ForeignKey<O, CodeQualityReportRecord> childPath, InverseForeignKey<O, CodeQualityReportRecord> parentPath) {
        super(path, childPath, parentPath, CODE_QUALITY_REPORT);
    }

    /**
     * A subtype implementing {@link Path} for simplified path-based joins.
     */
    public static class CodeQualityReportPath extends CodeQualityReport implements Path<CodeQualityReportRecord> {

        private static final long serialVersionUID = 1L;
        public <O extends Record> CodeQualityReportPath(Table<O> path, ForeignKey<O, CodeQualityReportRecord> childPath, InverseForeignKey<O, CodeQualityReportRecord> parentPath) {
            super(path, childPath, parentPath);
        }
        private CodeQualityReportPath(Name alias, Table<CodeQualityReportRecord> aliased) {
            super(alias, aliased);
        }

        @Override
        public CodeQualityReportPath as(String alias) {
            return new CodeQualityReportPath(DSL.name(alias), this);
        }

        @Override
        public CodeQualityReportPath as(Name alias) {
            return new CodeQualityReportPath(alias, this);
        }

        @Override
        public CodeQualityReportPath as(Table<?> alias) {
            return new CodeQualityReportPath(alias.getQualifiedName(), this);
        }
    }
    ...
    public TestRunPath testRun() {
        if (_testRun == null)
            _testRun = new TestRunPath(this, Keys.CODE_QUALITY_REPORT__CODE_QUALITY_REPORT_TEST_RUN_ID_FKEY, null);
    ...
    @Override
    public CodeQualityReport as(Table<?> alias) {
        return new CodeQualityReport(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public CodeQualityReport rename(Table<?> name) {
        return new CodeQualityReport(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public CodeQualityReport where(Condition condition) {
        return new CodeQualityReport(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public CodeQualityReport where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public CodeQualityReport where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public CodeQualityReport where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public CodeQualityReport where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public CodeQualityReport where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public CodeQualityReport where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public CodeQualityReport where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public CodeQualityReport whereExists(Select<?> select) {
     ...
     */
    @Override
    public CodeQualityReport whereNotExists(Select<?> select) {
