...
public class Indexes {
    ...
    public static final Index REPOSITORY_CURRENT_COVERAGE_REPO_NAME_IDX = Internal.createIndex(DSL.name("repository_current_coverage_repo_name_idx"), RepositoryCurrentCoverage.REPOSITORY_CURRENT_COVERAGE, new OrderField[] { RepositoryCurrentCoverage.REPOSITORY_CURRENT_COVERAGE.REPO_NAME }, false);
