...
public class Keys {
    ...
    public static final UniqueKey<RepositoryCurrentCoverageRecord> REPOSITORY_CURRENT_COVERAGE_PKEY = Internal.createUniqueKey(RepositoryCurrentCoverage.REPOSITORY_CURRENT_COVERAGE, DSL.name("repository_current_coverage_pkey"), new TableField[] { RepositoryCurrentCoverage.REPOSITORY_CURRENT_COVERAGE.ID }, true);
    public static final UniqueKey<RepositoryCurrentCoverageRecord> REPOSITORY_CURRENT_COVERAGE_REPO_NAME_PROJECT_NAME_KEY = Internal.createUniqueKey(RepositoryCurrentCoverage.REPOSITORY_CURRENT_COVERAGE, DSL.name("repository_current_coverage_repo_name_project_name_key"), new TableField[] { RepositoryCurrentCoverage.REPOSITORY_CURRENT_COVERAGE.REPO_NAME, RepositoryCurrentCoverage.REPOSITORY_CURRENT_COVERAGE.PROJECT_NAME }, true);
    ...
    public static final ForeignKey<CodeCoverageFileRecord, CodeCoverageRunRecord> CODE_COVERAGE_FILE__CODE_COVERAGE_FILE_CODE_COVERAGE_RUN_ID_FKEY = Internal.createForeignKey(CodeCoverageFile.CODE_COVERAGE_FILE, DSL.name("code_coverage_file_code_coverage_run_id_fkey"), new TableField[] { CodeCoverageFile.CODE_COVERAGE_FILE.CODE_COVERAGE_RUN_ID }, Keys.CODE_COVERAGE_RUN_PKEY, new TableField[] { CodeCoverageRun.CODE_COVERAGE_RUN.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<CodeCoverageFileRecord, CodeCoverageStatsRecord> CODE_COVERAGE_FILE__CODE_COVERAGE_FILE_STATS_ID_FKEY = Internal.createForeignKey(CodeCoverageFile.CODE_COVERAGE_FILE, DSL.name("code_coverage_file_stats_id_fkey"), new TableField[] { CodeCoverageFile.CODE_COVERAGE_FILE.STATS_ID }, Keys.CODE_COVERAGE_STATS_PKEY, new TableField[] { CodeCoverageStats.CODE_COVERAGE_STATS.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<CodeQualityReportRecord, TestRunRecord> CODE_QUALITY_REPORT__CODE_QUALITY_REPORT_TEST_RUN_ID_FKEY = Internal.createForeignKey(CodeQualityReport.CODE_QUALITY_REPORT, DSL.name("code_quality_report_test_run_id_fkey"), new TableField[] { CodeQualityReport.CODE_QUALITY_REPORT.TEST_RUN_ID }, Keys.TEST_RUN_PKEY, new TableField[] { TestRun.TEST_RUN.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<GitMetadataRecord, TestRunRecord> GIT_METADATA__GIT_METADATA_TEST_RUN_ID_FKEY = Internal.createForeignKey(GitMetadata.GIT_METADATA, DSL.name("git_metadata_test_run_id_fkey"), new TableField[] { GitMetadata.GIT_METADATA.TEST_RUN_ID }, Keys.TEST_RUN_PKEY, new TableField[] { TestRun.TEST_RUN.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<PerformanceResultsRecord, TestRunRecord> PERFORMANCE_RESULTS__PERFORMANCE_RESULTS_TEST_RUN_ID_FKEY = Internal.createForeignKey(PerformanceResults.PERFORMANCE_RESULTS, DSL.name("performance_results_test_run_id_fkey"), new TableField[] { PerformanceResults.PERFORMANCE_RESULTS.TEST_RUN_ID }, Keys.TEST_RUN_PKEY, new TableField[] { TestRun.TEST_RUN.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ResultsMetadataRecord, TestRunRecord> RESULTS_METADATA__RESULTS_METADATA_TEST_RUN_ID_FKEY = Internal.createForeignKey(ResultsMetadata.RESULTS_METADATA, DSL.name("results_metadata_test_run_id_fkey"), new TableField[] { ResultsMetadata.RESULTS_METADATA.TEST_RUN_ID }, Keys.TEST_RUN_PKEY, new TableField[] { TestRun.TEST_RUN.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<TestCaseRecord, TestSuiteRecord> TEST_CASE__TEST_CASE_TEST_SUITE_ID_FKEY = Internal.createForeignKey(TestCase.TEST_CASE, DSL.name("test_case_test_suite_id_fkey"), new TableField[] { TestCase.TEST_CASE.TEST_SUITE_ID }, Keys.TEST_SUITE_PKEY, new TableField[] { TestSuite.TEST_SUITE.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<TestFailureRecord, TestCaseRecord> TEST_FAILURE__TEST_FAILURE_TEST_CASE_ID_FKEY = Internal.createForeignKey(TestFailure.TEST_FAILURE, DSL.name("test_failure_test_case_id_fkey"), new TableField[] { TestFailure.TEST_FAILURE.TEST_CASE_ID }, Keys.TEST_CASE_PKEY, new TableField[] { TestCase.TEST_CASE.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<TestRunSystemAttributesRecord, TestRunRecord> TEST_RUN_SYSTEM_ATTRIBUTES__TEST_RUN_SYSTEM_ATTRIBUTES_TEST_RUN_PUBLIC_ID_FKEY = Internal.createForeignKey(TestRunSystemAttributes.TEST_RUN_SYSTEM_ATTRIBUTES, DSL.name("test_run_system_attributes_test_run_public_id_fkey"), new TableField[] { TestRunSystemAttributes.TEST_RUN_SYSTEM_ATTRIBUTES.TEST_RUN_PUBLIC_ID }, Keys.TEST_RUN_PUBLIC_ID_KEY, new TableField[] { TestRun.TEST_RUN.PUBLIC_ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<TestSuiteRecord, TestRunRecord> TEST_SUITE__TEST_SUITE_TEST_RUN_ID_FKEY = Internal.createForeignKey(TestSuite.TEST_SUITE, DSL.name("test_suite_test_run_id_fkey"), new TableField[] { TestSuite.TEST_SUITE.TEST_RUN_ID }, Keys.TEST_RUN_PKEY, new TableField[] { TestRun.TEST_RUN.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<TestSuiteRecord, TestSuiteGroupRecord> TEST_SUITE__TEST_SUITE_TEST_SUITE_GROUP_ID_FKEY = Internal.createForeignKey(TestSuite.TEST_SUITE, DSL.name("test_suite_test_suite_group_id_fkey"), new TableField[] { TestSuite.TEST_SUITE.TEST_SUITE_GROUP_ID }, Keys.TEST_SUITE_GROUP_PKEY, new TableField[] { TestSuiteGroup.TEST_SUITE_GROUP.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<TestSuiteGroupRecord, TestRunRecord> TEST_SUITE_GROUP__TEST_SUITE_GROUP_TEST_RUN_ID_FKEY = Internal.createForeignKey(TestSuiteGroup.TEST_SUITE_GROUP, DSL.name("test_suite_group_test_run_id_fkey"), new TableField[] { TestSuiteGroup.TEST_SUITE_GROUP.TEST_RUN_ID }, Keys.TEST_RUN_PKEY, new TableField[] { TestRun.TEST_RUN.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
}
