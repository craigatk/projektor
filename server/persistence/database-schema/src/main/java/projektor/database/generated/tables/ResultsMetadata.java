...
public class ResultsMetadata extends TableImpl<ResultsMetadataRecord> {
    ...
    private static final long serialVersionUID = -281266005;
     ...
     */
    public final TableField<ResultsMetadataRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('results_metadata_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.results_metadata.test_run_id</code>.
     */
    public final TableField<ResultsMetadataRecord, Long> TEST_RUN_ID = createField(DSL.name("test_run_id"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>public.results_metadata.ci</code>.
     */
    public final TableField<ResultsMetadataRecord, Boolean> CI = createField(DSL.name("ci"), org.jooq.impl.SQLDataType.BOOLEAN, this, "");
    ...
    public Identity<ResultsMetadataRecord, Long> getIdentity() {
        return Keys.IDENTITY_RESULTS_METADATA;
    }
