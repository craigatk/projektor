...
public class GitRepository extends TableImpl<GitRepositoryRecord> {
    ...
    private static final long serialVersionUID = 42364746;
     ...
     */
    public final TableField<GitRepositoryRecord, String> REPO_NAME = createField(DSL.name("repo_name"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.git_repository.org_name</code>.
     */
    public final TableField<GitRepositoryRecord, String> ORG_NAME = createField(DSL.name("org_name"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");
