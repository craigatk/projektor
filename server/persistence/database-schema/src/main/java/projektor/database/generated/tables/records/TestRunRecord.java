...
public class TestRunRecord extends UpdatableRecordImpl<TestRunRecord> implements Record12<Long, String, Integer, Integer, Integer, Integer, Boolean, BigDecimal, BigDecimal, BigDecimal, Timestamp, BigDecimal> {

    private static final long serialVersionUID = -972130260;
    ...
    @Override
    public Row12<Long, String, Integer, Integer, Integer, Integer, Boolean, BigDecimal, BigDecimal, BigDecimal, Timestamp, BigDecimal> valuesRow() {
    ...
    @Override
    public TestRunRecord values(Long value1, String value2, Integer value3, Integer value4, Integer value5, Integer value6, Boolean value7, BigDecimal value8, BigDecimal value9, BigDecimal value10, Timestamp value11, BigDecimal value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TestRunRecord(Long id, String publicId, Integer totalTestCount, Integer totalPassingCount, Integer totalSkippedCount, Integer totalFailureCount, Boolean passed, BigDecimal cumulativeDuration, BigDecimal averageDuration, BigDecimal slowestTestCaseDuration, Timestamp createdTimestamp, BigDecimal wallClockDuration) {
        super(TestRun.TEST_RUN);
