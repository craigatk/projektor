...
class ResultsXmlLoader {
    ...
    fun cypressFailingDashboardTestWithScreenshots() =
        loadTextFromFile("cypress-file-path/cypress-failing-dashboard-test-with-screenshots.xml")

    fun cypressFailingAttachmentsTestWithScreenshot() =
        loadTextFromFile("cypress-file-path/cypress-failing-attachments-test-with-screenshot.xml")
