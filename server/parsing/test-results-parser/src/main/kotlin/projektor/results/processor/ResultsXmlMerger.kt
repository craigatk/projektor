...
object ResultsXmlMerger {
    fun cleanAndMergeBlob(resultsBlob: String): String =
        resultsBlob
    ...
    private fun removeXmlHeader(resultXml: String) =
        resultXml
            .replace(Regex("""<\?xml.*\?>"""), "")

    private fun wrappedInTestSuitesWrapperXml(resultsXml: String) =
        """
