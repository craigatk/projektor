...
""",
    ...
    fun stubGetRepoInstallationNotFound(
        orgName: String,
        repoName: String,
    ) {
        wireMockServer.stubFor(
    ...
    fun stubCreateInstallationAccessToken(
        installationId: Int,
        token: String,
        repositoryId: Int,
    ) {
...
""",
    ...
    fun stubListComments(
        ...
        val responseBodies =
            commentBodies.mapIndexed { idx, commentBody ->
"""
  {
  "id": ${idx + 1},
  "node_id": "MDEyOklzc3VlQ29tbWVudDE=",
...
""".trimIndent()
    ...
    fun findAddCommentRequestBodies(
        orgName: String,
        repoName: String,
        issueId: Int,
