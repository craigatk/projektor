...
describe("Performance results", () => {
  it("should display performance results on dashboard", () => {
    ...
    cy.getByTestId("performance-result-average-1").should("contain", "11.072");
    cy.getByTestId("performance-result-p95-1").should("contain", "22.294");
    cy.getByTestId("performance-result-maximum-1").should("contain", "410.53");
